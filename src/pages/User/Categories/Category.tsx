...
export default function Categories() {
  const handleDownload = () => {
    ...
    const pdfUrl = "/assets/sambhasha-xxvi-categories.pdf";
    const link = document.createElement("a");
    link.href = pdfUrl;
    link.download = "SAMBHASHA_XXVI_Categories.pdf";
  ...
  return (
    <div className="flex flex-col items-center w-full px-4 py-10 sm:px-8 md:px-12 lg:px-16">
      ...
      <p className="text-sm text-gray-500 text-center max-w-sm sm:max-w-md leading-relaxed mb-6">
        Download the official PDF more about competition categories
